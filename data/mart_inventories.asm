...
; Pewter
PewterCashierText::
	TX_MART POKE_BALL, POTION, ESCAPE_ROPE, ANTIDOTE, BURN_HEAL, AWAKENING, PARLYZ_HEAL, POKE_DOLL
...
; Cinnabar
CinnabarCashierText::
	TX_MART BUG_STONE, ULTRA_BALL, GREAT_BALL, THIEF_BALL, HYPER_POTION, MAX_REPEL, ESCAPE_ROPE, FULL_HEAL, REVIVE
...
; Indigo
IndigoCashierText::
	TX_MART ULTRA_BALL, GREAT_BALL, THIEF_BALL, FULL_RESTORE, MAX_POTION, FULL_HEAL, REVIVE, MAX_REPEL
